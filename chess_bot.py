...
if sys.platform == "win32":
    ...
    top_left = (450, 153)
    bottom_right = (1625, 1329)
    def take_screenshot(output_path="screenshot.png"):
        screenshot = pyautogui.screenshot()
        screenshot.save(output_path)
elif sys.platform == "darwin":
    STOCKFISH_PATH = "stockfish"  # suppose que stockfish est dans le PATH sur Mac
    top_left = (477, 353)
...
def perform_drag_and_drop_with_pyautogui(move, board_top_left, square_size, scale_factor, button="left"):
...
if __name__ == "__main__":
    ...
    if active_color == "w" and state_A:
        ...
        if best_move_A is not None:
            ...
            perform_drag_and_drop_with_pyautogui(move_str, top_left, square_size, calculate_scale_factor(), button="left")
